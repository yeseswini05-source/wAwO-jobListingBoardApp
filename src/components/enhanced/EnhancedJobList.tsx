...
import { FiGrid, FiList, FiLoader, FiAlertCircle, FiSearch } from 'react-icons/fi';
...
const EnhancedJobList: React.FC = () => {
  ...
  const LoadingState: React.FC = () => (
    ...
    >
      <div className="loading-content">
        ...
        <p>We're searching through thousands of jobs to find the perfect matches for you.</p>
      </div>
    </motion.div>
  );
  ...
  const ErrorState: React.FC = () => (
    ...
    >
      <div className="error-content">
        ...
        <p>We couldn't load the job listings. Please try refreshing the page.</p>
        <button 
          className="retry-btn"
  ...
  return (
    <section className="enhanced-job-list" role="main" aria-label="Job listings">
      {/* List Header */}
      <div className="list-header">
        ...
        {/* View Mode Toggle */}
        <div className="view-controls" role="tablist" aria-label="View mode">
          <button
        ...
        >
          <AnimatePresence mode="popLayout">
            {filteredAndSortedJobs.map((job, index) => (
              ...
              >
                <EnhancedJobCard job={job} viewMode={viewMode} />
              </motion.div>
            ))}
          </AnimatePresence>
        </motion.div>
